    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="status" label="状态" width="70">
        <!-- <template slot-scope="scope">
          <div slot="reference">
            <p size="medium" >{{ scope.row.status + "°C" }}
            </p>
          </div>
        </template> -->
      </el-table-column>
      ...
      <el-table-column prop="idate" label="就诊日期" width="120">
      </el-table-column>
    ...
    <div class="block">
      ...
      >
        <el-form :model="EmpIden" ref="EmpIden">
          ...
          <el-form-item label="状态" :label-width="formLabelWidth">
            <el-radio v-model="EmpIden.status" label="确诊">确诊</el-radio>
            <el-radio v-model="EmpIden.status" label="疑似">疑似</el-radio>
            <el-radio v-model="EmpIden.status" label="治愈">治愈</el-radio>
            <el-radio v-model="EmpIden.status" label="死亡">死亡</el-radio>
          </el-form-item>
          ...
          <el-form-item label="所属部门" :label-width="formLabelWidth">
            <el-select v-model="EmpIden.depart" clearable placeholder="请选择">
              <el-option
      ...
      >
        <el-form :model="addEmpIden">
          ...
          <el-form-item label="状态" :label-width="formLabelWidth">
            <el-radio v-model="addEmpIden.status" label="确诊">确诊</el-radio>
            <el-radio v-model="addEmpIden.status" label="疑似">疑似</el-radio>
            <el-radio v-model="addEmpIden.status" label="治愈">治愈</el-radio>
            <el-radio v-model="addEmpIden.status" label="死亡">死亡</el-radio>
          </el-form-item>
...
export default {
  ...
  methods: {
    reload() {
      axios
        .get(
          "http://localhost:8080/empiden/findAll/" +
            this.currentpage +
            "/" +
            this.pagesize
        )
