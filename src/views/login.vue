          ...
          >
            ...
            <el-form-item style="margin-bottom: 60px">
              ...
              <el-button
                ...
                type="success"
                :loading="loading"
                @click="(dialogFormVisible = true), (user = {})"
                >注册</el-button
              >
            </el-form-item>
          </el-form>
  ...
  methods: {
    register() {
      ...
      if (this.user.username == "" || this.user.password == "") {
        ...
        axios
          .post("http://localhost:8080/userlogin/register", this.user)
          .then((resp) => {
            console.log(resp);
            this.loading = true;
    ...
    handleLogin() {
      ...
      axios
        .post("http://localhost:8080/userlogin/user", this.loginForm)
        .then((resp) => {
          console.log(resp);
          this.loading = true;
          if (this.loginForm.username == "" || this.loginForm.password == "") {
            ...
            if (resp.status == 200) {
              ...
              if (resp.data.isAdministrator == true) {
                //是管理员
